...
| LED Brightness | `f3e7c6e5-0d32-4c5a-ac6e-3456789012cd` | WRITE | JSON | Luminosita' + on/off `{"brightness":60,"enabled":true}` |
...
```json
{"enabled":true,"motionDetected":false,"quality":128,"intensity":12,"direction":"up","speed":1.2,"confidence":80,"gesture":"none"}
```
